...
public class MenuPrincipalFrame extends javax.swing.JFrame {
     ...
     *
     * @param id
     * @throws Excepciones.ControlException
     */
     ...
     * @throws Excepciones.ControlException
     */
    public MenuPrincipalFrame(int id) throws ControlException {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnSeelecionar = new javax.swing.JButton();
        ...
        btnSeelecionar.setBackground(new java.awt.Color(255, 153, 153));
        btnSeelecionar.setText("Seleccionar");
        btnSeelecionar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSeelecionarActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(182, 182, 182)
                        .addComponent(CuentasComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(235, 235, 235)
                        .addComponent(btnSeelecionar)))
    ...
    private void btnSeelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeelecionarActionPerformed
        Cuenta c = (Cuenta) CuentasComboBox.getSelectedItem();
        try {
            MenuPrincipalFrame mpf = new MenuPrincipalFrame(c.getIdCuenta());
            mpf.show();
            dispose();
    ...
    }//GEN-LAST:event_btnSeelecionarActionPerformed
    ...
    private javax.swing.JButton btnSeelecionar;
