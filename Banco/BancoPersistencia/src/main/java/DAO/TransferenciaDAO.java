...
public class TransferenciaDAO {
    ...
    public boolean realizarTransferencia(TransferenciaDTO transferenciaDTO) {
        try {
            ...
            if (verificarSaldoSuficiente(transferenciaDTO.getCuentaOrigen(), transferenciaDTO.getMonto())) {

                // Actualizar saldo en la cuenta de origen
                actualizarSaldo(transferenciaDTO.getCuentaOrigen(), -transferenciaDTO.getMonto());

                // Actualizar saldo en la cuenta de destino
                actualizarSaldo(transferenciaDTO.getCuentaDestino(), transferenciaDTO.getMonto());
