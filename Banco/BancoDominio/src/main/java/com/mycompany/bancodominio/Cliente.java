...
public class Cliente {
    ...
    public Cliente(String nombre, String apellidoP, String apellidoM, String calle, String numero, String colonia, String fechaN, int edad) {
        this.nombre = nombre;
        this.apellidoP = apellidoP;
        this.apellidoM = apellidoM;
        this.calle = calle;
    ...
    public Cliente(int clienteID, String nombre, String apellidoP, String apellidoM, String calle, String numero, String colonia, String fechaN, int edad) {
